...
export function SessionCard({
  ...
  const card = (
    ...
    >
      ...
      {session.blocked && (
        <div className={cn("px-4 pl-8 pt-1.5", (nonReminderCount > 0 || reminderCount > 0) ? "pb-1" : "pb-4")}>
      ...
      {(nonReminderCount > 0 || reminderCount > 0) && (
        <div className={cn("px-4 pb-4 pl-8 flex flex-row flex-wrap items-center gap-x-3 gap-y-0.5", !session.blocked && "pt-1.5")}>
          {nonReminderCount > 0 && (
